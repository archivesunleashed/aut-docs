...
```shell
spark-shell --driver-memory 4G --packages "io.archivesunleashed:aut:0.70.0"
```
...
```shell
spark-shell --master local[12] --driver-memory 4G --packages "io.archivesunleashed:aut:0.70.0"
```
...
```shell
spark-shell --master local[12] --driver-memory 90G --conf spark.network.timeout=10000000 --packages "io.archivesunleashed:aut:0.70.0"
```
