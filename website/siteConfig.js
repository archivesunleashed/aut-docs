...
const siteConfig = {
  ...
  headerLinks: [
    ...
    {
      href: 'https://github.com/archivesunleashed/aut', label: 'GitHub'
    },
    {
      href: 'https://news.archivesunleashed.org/', label: 'News'
    },
  ],
  ...
  */
  ...
  copyright: `CC BY 2.0 ${new Date().getFullYear()} Archives Unleashed Project`,
